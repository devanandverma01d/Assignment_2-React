...
//2.impor from somelocation/ SomeLibraryimport React from 'react'
            ...
            <div className="container px-4 px-lg-5">
                <div className="row gx-4 gx-lg-5 justify-content-center">
                    <div className="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div className="post-preview">
                            <a href="post.html">
                                <h2 className="post-title">I believe every human has a finite number of heartbeats. I don't
                                    intend
                        ...
                        <div className="post-preview">
                            <a href="post.html">
                                ...
                                <h3 className="post-subtitle">We predict too much for the next year and yet far too little for
                                    the
                                    next ten.</h3>
                            </a>
                            <p className="post-meta">
                        ...
                        <div className="post-preview">
                            <a href="post.html">
                                ...
                                <h3 className="post-subtitle">Many say exploration is part of our destiny, but it’s actually our
